...
class Config(object):
    def __init__(self):
        ...
        if profile == 'predator':
            ...
            self.mros_ssc_path = 'G:\\mros\\polysomnography\\annotations-events-profusion\\visit1'
            self.shhs_ds_path = 'H:\\shhs\\datasets\\shhs1-dataset-0.15.0.csv'
            self.shhs_ssc_path = 'H:\\shhs\\polysomnography\\annotations-events-profusion\\shhs1'
            ...
            self.hpap_ds_path = "H:\\homepap\\datasets\\homepap-baseline-dataset-0.1.0.csv"
            self.hpap_ssc_path = "H:\\homepap\\polysomnography\\annotations-events-profusion\\lab\\full"
            ...
            self.cfs_ds_path = '/oak/stanford/groups/mignot/cfs/datasets/cfs-visit5-dataset-0.4.0.csv'
            ...
            self.shhs_ds_path = '/oak/stanford/groups/mignot/shhs/datasets/shhs1-dataset-0.14.0.csv'
            self.shhs_ssc_path = '/home/users/abk26/SleepAge/Scripts/data/shhs/polysomnography/shhs1/'
            self.wsc_ds_path = '/home/users/abk26/SleepAge/Scripts/data/WSC_PLM_ data_all.xlsx'
            self.wsc_ssc_path = '/oak/stanford/groups/mignot/psg/WSC_EDF/'
            self.stages_ds_path = '/home/users/abk26/SleepAge/Scripts/data/PatientDemographics.xlsx'
